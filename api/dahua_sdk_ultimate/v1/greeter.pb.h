...
/* @@protoc_insertion_point(class_definition:helloworld.v1.HelloRequest) */ {
 public:
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "helloworld.v1.HelloRequest"; }
...
/* @@protoc_insertion_point(class_definition:helloworld.v1.HelloReply) */ {
 public:
 ...
 private:
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() { return "helloworld.v1.HelloReply"; }
...
inline const std::string& HelloRequest::name() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:helloworld.v1.HelloRequest.name)
...
inline PROTOBUF_ALWAYS_INLINE void HelloRequest::set_name(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:helloworld.v1.HelloRequest.name)
}
inline std::string* HelloRequest::mutable_name() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:helloworld.v1.HelloRequest.name)
  return _s;
}
...
inline std::string* HelloRequest::release_name() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:helloworld.v1.HelloRequest.name)
...
inline void HelloRequest::set_allocated_name(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:helloworld.v1.HelloRequest.name)
}
...
inline const std::string& HelloReply::message() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:helloworld.v1.HelloReply.message)
...
inline PROTOBUF_ALWAYS_INLINE void HelloReply::set_message(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:helloworld.v1.HelloReply.message)
}
inline std::string* HelloReply::mutable_message() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_message();
  // @@protoc_insertion_point(field_mutable:helloworld.v1.HelloReply.message)
  return _s;
}
...
inline std::string* HelloReply::release_message() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:helloworld.v1.HelloReply.message)
...
inline void HelloReply::set_allocated_message(std::string* value) {
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:helloworld.v1.HelloReply.message)
}
